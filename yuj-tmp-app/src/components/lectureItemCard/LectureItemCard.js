                ...
                <div className="card-body">
                    <div className='flex'>
                        <a href='' className='flex align-center'>
                            <img src='./assets/YujMainLogo.svg' style={{ height: '14px', paddingRight: '7px' }} />
                            <div style={{ fontSize: '12px', fontWeight: 'bold' }}>요가소년</div>
                        </a>
                        <div></div>
                    </div>
                    ...
                    <p style={{ fontSize: '12px' }}>이 요가 루틴 영상은 코어근육을 강화하는 데에 초점을 두고 구성한 프로그램입니다. 다 마치고 나면 몸 전체에...</p>
